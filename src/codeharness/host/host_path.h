...
class HostPath {
 public:
  HostPath(std::string_view path, std::string_view path_class);
  explicit HostPath(const std::filesystem::path& path, std::string_view path_class = "posix");

...
class RuntimeBundle {
 public:
  RuntimeBundle(std::filesystem::path cwd, PermissionSettings permission, HookRegistry hooks,
                ...
                std::string provider_type = "echo", std::string base_url = {}, std::string profile_id = "default",
                std::string profile_label = "Default", std::vector<RuntimeModelProfile> model_profiles = {});
 ...
 private:
  ...
  std::unique_ptr<ChatProvider> chat_provider_;
  Engine engine_;
